...
namespace daybreak_robot_coordinator
{

    class DaybreakActionServer : public BT::TreeExecutionServer
    {
    public:
        DaybreakActionServer(const rclcpp::NodeOptions &options) : TreeExecutionServer(options)
        {
...
int main(int argc, char *argv[])
{
    ...
    auto action_server = std::make_shared<daybreak_robot_coordinator::DaybreakActionServer>(options);
